...
public class SignUPActivity extends LoginActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        editTextConfirmPassword = (EditText) findViewById(R.id.etReEnterPassword);
         ...
         */
        btnCreateAccount = (Button) findViewById(R.id.bCreateAccount);
        ...
        btnHomeLocation = (Button) findViewById(R.id.bSetLocation);
